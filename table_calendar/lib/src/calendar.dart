...
class TableCalendar extends StatefulWidget {
  ...
  final EdgeInsets selectionMargin;
  ...
  TableCalendar({
    ...
    this.selectionMargin = const EdgeInsets.only(left: 8.0,right: 8.0,top: 8.0,bottom: 8.0),
    this.initialSelectedDay,
    this.startDay,
    this.endDay,
    this.selectedBoxDecoration = const BoxDecoration(shape: BoxShape.circle,color:  Colors.white),
...
class _TableCalendarState extends State<TableCalendar>
        ...
        if (widget.builders.markersBuilder != null) {
          ...
          children.add(
            Positioned(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: events.take(widget.calendarStyle.markersMaxAmount >0 ?1:0)
  ...
  Widget _buildCellContent(DateTime date) {
    ...
    if (isUnavailable) {
      ...
      return _CellWidget(
        ...
        cellMargin: this.widget.selectionMargin,
        selectedDecoration: this.widget.selectedBoxDecoration,
  ...
  Widget _buildMarker(DateTime date, dynamic event) {
    if (widget.builders.singleMarkerBuilder != null) {
      if(!widget.calendarController.isSelected(date))
